...
export default function PrivacyPolicyPage() {
  ...
  const sections = [
    { 
      ...
      content: 'We collect information you provide directly to us, such as when you create an account, book an appointment, or contact us for support. This may include your name, email address, phone number, company details, and appointment information.',
      details: [
    ...
    { 
      ...
      content: 'We use the information we collect to provide, maintain, and improve our services, to process your appointments, to communicate with you, to protect the security of our platform, and to comply with legal obligations.',
      details: [
    ...
    { 
      ...
      content: 'Your data is stored securely on encrypted servers. We implement industry-standard security measures including encryption, firewalls, and secure socket layer technology to protect your personal information.',
      details: [
    ...
    { 
      ...
      content: 'We do not sell, trade, or rent your personal information to third parties. We may share information with service providers who assist us in operating our platform, such as hosting services, payment processors, and email delivery services.',
      details: [
    ...
    { 
      ...
      content: 'We use cookies and similar tracking technologies to enhance your experience, analyze usage patterns, and remember your preferences. You can control cookie settings through your browser preferences.',
      details: [
    ...
    { 
      ...
      content: 'We may send you emails about your appointments, service updates, security alerts, and administrative messages. You can opt out of promotional emails at any time by clicking the unsubscribe link.',
      details: [
        ...
        '• Survey requests for service improvement'
      ]
    },
    { 
      icon: Server, 
      title: 'Data Retention', 
      content: 'We retain your personal information for as long as your account is active or as needed to provide you services. We will retain and use your information as necessary to comply with legal obligations, resolve disputes, and enforce agreements.',
      details: [
    ...
    { 
      icon: UserCheck, 
      title: 'Your Rights', 
      content: 'You have the right to access, correct, update, or delete your personal information. You can do this through your account settings or by contacting our support team.',
      details: [
    ...
    { 
      ...
      details: [
        ...
        '• Regular reviews for compliance updates',
  ...
  const complianceBadges = [
    ...
    { name: 'PCI DSS', icon: CreditCard, color: 'text-rose-600' },
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-indigo-50/20 pt-16">
        ...
        <section className="py-16">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            {/* Introduction with Trust Badge */}
            <div className="mb-12 p-6 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl border border-blue-100 animate-fadeInUp">
            ...
            <div className="space-y-4">
              {sections.map((section, index) => {
                ...
                return (
                  <div 
                    key={index} 
                    className="bg-white rounded-2xl shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100 overflow-hidden animate-fadeInUp"
                  ...
                  >
                    ...
                    >
                      <div className="flex items-start gap-4">
                        <div className="h-12 w-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl flex items-center justify-center flex-shrink-0 shadow-md group-hover:scale-110 transition-transform">
                ...
                {yourRights.map((right, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="inline-block mt-3 text-xs text-emerald-600 opacity-0 group-hover:opacity-100 transition">Request Now →</span>
                    </button>
                  );
                })}
              </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <div className="relative">
                    <a 
                      ...
                      className="inline-flex items-center justify-center gap-2 bg-white text-indigo-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-100 transition shadow-md w-full"
                    >
